...
/*
line numbers
You will choose between which story will be read so m for mary had a little lamb and w for War and peace and it should give their stories in the terminal.
...
int main() {
    ...
    std::cout << "You may choose between which you'd like to read. [ m = Mary Lamb or w = War And Peace]: ";
