...
/*
Prime Factoral
It will choose numbers within 1-50 and tell you if it's prime or not and if it is a prime number it'll put down the factor for it.
...
int main(){
    ...
    do
    {
        number = rand() % 51;
        x = factorial(number);
        if (isprime(number) == 0 || number < 2)
        {
            std::cout << number << " is not a prime number." << std::endl;
        }
        else{
            std::cout << "The chosen prime number is, " << number << std::endl;
            std::cout << "This is the factorial, " << x << std::endl;
            
        }
        std::cout << "Do you wish to try again? (y/n)";
